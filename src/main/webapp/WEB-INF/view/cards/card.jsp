...
<div class="card">
    <div class="additional">
      ...
      <div class="more-info">
        ...
        <div class="coords">
          <span>Email: </span>
          <span>${contact.contactEmailAddress}</span>
        </div>
        <spring:url var = "urlEditContact" value ="/user/editContact">
			<spring:param name="contactId" value = "${contact.contactId}"></spring:param>
		</spring:url>
		<spring:url var = "urlDeleteContact" value ="/user/deleteContact">
			<spring:param name="contactId" value = "${contact.contactId}"></spring:param>
		</spring:url>
        <div class="stats">
          <div>
            <i class="fa fa-pencil-square"></i>
            <div class="title"><a href="${urlEditContact}" id="link">Edit</a></div>
          </div>
          <div>
