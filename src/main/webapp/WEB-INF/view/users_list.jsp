...
<head>
	...
	<spring:url var = "urlUserSearch" value ="/admin/searchUser"/>
	<spring:url var = "urlBulkDeleteUsers" value ="/admin/bulkDeleteUsers"/>
...
<body>
	<div class="limiter">
		<div class="container-login100">
			...
			<spring:if test="${empty usersList}">
						<script>
						Swal.fire({
							  type: 'error',
							  title: 'Oops... No Users Found',
							  text: 'Please Create A User Before You Can See Them',
			...
			<!-- BODY -->
				...
				<form:form class="validate-form" action="${urlUserSearch}" style=" margin-bottom: 10px;" modelAttribute="searchCommand">
				...
				<div class="scrollabletable">
					<form id="deleteForm" action="${urlBulkDeleteUsers}">
						<spring:forEach items="${usersList}" var = "user" varStatus = "contactData">
							<%@ include file="cards/user_card.jsp"%>
						</spring:forEach>
					</form>
				</div>
				</div>
